...
IMGUI_IMPL_API bool ImGui_ImplSDL2_Init()
{
    ...
    // SPARTAN_TWEAK
    bd->Window    = static_cast<SDL_Window*>(Window::GetHandleSDL());
    ...
    main_viewport->PlatformHandleRaw = Window::GetHandleRaw(); // SPARTAN_TWEAK
    ...
    if ((io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable) && (io.BackendFlags & ImGuiBackendFlags_PlatformHasViewports))
        ImGui_ImplSDL2_InitPlatformInterface(bd->Window); // SPARTAN_TWEAK
...
static void ImGui_ImplSDL2_InitPlatformInterface(SDL_Window* window)
{
    ...
    vd->GLContext                   = nullptr; // SPARTAN_TWEAK
